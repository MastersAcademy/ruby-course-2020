;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="d8959caaca5a99df5e8234ebbd3a7eb6";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["6rNmCZH9a_q1"]={appId:"XzVIEqe1R2kW",scope:{}};;CloudflareApps.installs["6rNmCZH9a_q1"].options={"ie":7};;CloudflareApps.installs["qjwzgvsyXpcB"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["qjwzgvsyXpcB"].options={"id":"UA-56190313-1","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['qjwzgvsyXpcB'].URLPatterns)){(function(){var options=CloudflareApps.installs['qjwzgvsyXpcB'].options
var id
...
return}else if("qjwzgvsyXpcB"==='preview'){console.log('Cloudflare Google Analytics: Enabled',id)}
...
gtag('event','share',{method:'twitter',event_action:'tweet',content_id:targetUrl})}})}},false)}}())}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/YvaFjrLaWvov3IDzGvCF4_sV7Vo.js';document.head.appendChild(script);})();