class Tamagotchi
  ...
  def super_activity?
    if @health >= 10
      ...
      @thirst -= 0.5
      @health = 5
      puts "The '#{@name}' walked on the street more than necessary. His activity is outrageous!"
      puts 'He jumps on your favorite coat and heavily soils it with his paws!'
    end
  end
